...
public class BuscarLibro extends AsyncTask<String,Void,String> {
    ...
    BuscarLibro(TextView tituloLibro, TextView autorLibro, TextView anioLibro, TextView descripcionLibro){
    ...
    protected String doInBackground(String... strings) {
        return NetUtilities.obtenerInformacionLibro(strings[0]);
    }
        ...
        try{
            ...
            for (i=0 ; i<itemsArray.length(); i++){
                ...
                try {
                    ...
                    MainActivity.books.add(new Book(titulo,autores,anio,descripcion));
                }catch (Exception e){
                    e.printStackTrace();
                }
            }
